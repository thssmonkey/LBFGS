...
class LBFGSRegularizationPenaltyTest extends FlatSpec with Matchers {
  ...
  it should "correctly update weights and loss with L2 regularization penalty" in {
    ...
    val updatedWeights = LBFGSL2Regularization.takeStep(weights, gradient, 0.3, 0.01)
    val updatedLoss = LBFGSL2Regularization.regLoss(loss, updatedWeights, 0.3)
  ...
  it should "correctly update weights and loss with L1 regularization penalty" in {
    ...
    val updatedWeights = LBFGSL1Regularization.takeStep(weights, gradient, 0.3, 0.01)
    val updatedLoss = LBFGSL1Regularization.regLoss(loss, updatedWeights, 0.3)
  ...
  it should "correctly update weights and loss with no regularization penalty" in {
    ...
    val updatedWeights = LBFGSNoRegularization.takeStep(weights, gradient, 0.3, 0.01)
    val updatedLoss = LBFGSNoRegularization.regLoss(loss, updatedWeights, 0.3)
