...
class LBFGSPredictionFunctionITSuite extends FlatSpec with Matchers with FlinkTestBase {
  ...
  it should "correctly calculate linear predictions" in {
    ...
    val predFunction = LBFGSLinearPrediction

    val weightVector = DenseVector(-1.0, 1.0, 0.4, -0.4, 1.0)
